 ...
 * @author ASUS
 */
public class popuppelanggan2 extends javax.swing.JFrame {
 private Connection conn = new koneksi().koneksi();
    private DefaultTableModel tabmode;  
    public transaksi_tiket_theatre5d pelanggan = null;
    /**
     * Creates new form popuppelanggan1
     */
    public popuppelanggan2() {
        initComponents();
         datatable();
...
Object[]Baris={"Kode_Pelanggan","Nama","Jenis_kelamin","Nama_instasi","Hp"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popuppelanggan2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popuppelanggan2().setVisible(true);
            }
        });
    }
